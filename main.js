...
localStorage.removeItem('owned_sixtynine_leaf_clover');
localStorage.removeItem('revealed_owned_sixtynine_leaf_clover');
localStorage.removeItem('purchased_ts_owned_sixtynine_leaf_clover');
